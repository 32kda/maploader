...
public final class Logging {
    ...
    private static void logPrivate(Level level, Supplier<String> supplier) {
        ...
        if (LOGGER.isLoggable(level)) {
            StackTraceElement callingMethod = BugReport.getCallingMethod(1, Logging.class.getName(), name -> !"logPrivate".equals(name)); //TODO
    ...
    public static String getErrorMessage(Throwable t) {
        ...
        if (cause != null && !cause.equals(t)) {
            ...
            sb.append(". ").append("Cause: ").append(getErrorMessage(cause));
        }
        return sb.toString();
    }
