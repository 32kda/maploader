...
public class OsmChangeBuilder {
    ...
    public void start() {
        if (prologWritten)
            throw new IllegalStateException(MessageFormat.format("Prolog of OsmChange document already written. Please write only once."));
    ...
    private void checkProlog() {
        if (!prologWritten)
            throw new IllegalStateException(MessageFormat.format("Prolog of OsmChange document not written yet. Please write first."));
    }
