...
public class ObliqueMercator extends AbstractProj implements ICentralMeridianProvider {
    ...
    public void initialize(ProjParameters params) throws ProjectionConfigurationException {
        ...
        if (twoPoint) {
            if (params.lon1 == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lon_1"));
            if (params.lat1 == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lat_1"));
            if (params.lon2 == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lon_2"));
            if (params.lat2 == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lat_2"));
            ...
            if (Math.abs(lat1 - lat2) <= EPSILON ||
                ...
                throw new ProjectionConfigurationException(
                    MessageFormat.format("Unsuitable parameters ''{0}'' and ''{1}'' for two point method.", "lat_1", "lat_2"));
            }
            /*
            ...
            if (params.lonc == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lonc"));
            if (params.lat0 == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "lat_0"));
            if (params.alpha == null)
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter ''{0}'' required.", "alpha"));
            ...
            if ((azimuth > -1.5*Math.PI && azimuth < -0.5*Math.PI) ||
                ...
                throw new ProjectionConfigurationException(
                        MessageFormat.format("Illegal value for parameter ''{0}'': {1}", "alpha", Double.toString(params.alpha)));
            }
