...
public class AbstractLayer {
    ...
    private static Style defaultStyle = new Style(Color.ORANGE, new Color(200, 200, 200, 200), null, getDefaultFont());
    ...
    public AbstractLayer(String name, String description) {
        this(name, description, defaultStyle);
    }
