...
public class OsmConnection {
    ...
    protected void addOAuthAuthorizationHeader(HttpClient connection) throws OsmTransferException {
        ...
        try {
            ...
            throw new OsmTransferException(MessageFormat.format("Failed to sign a HTTP connection with an OAuth Authentication header"), e);
        }
    }
    ...
    protected void addAuth(HttpClient connection) throws OsmTransferException {
        ...
        if ("basic".equals(authMethod)) {
            ...
            String msg = MessageFormat.format("Unexpected value for preference ''{0}''. Got ''{1}''.", "osm-server.auth-method", authMethod);
            Logging.warn(msg);
