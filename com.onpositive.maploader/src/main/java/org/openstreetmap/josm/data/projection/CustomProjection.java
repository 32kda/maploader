...
public class CustomProjection extends AbstractProjection {
        ...
        if (pref == null) {
            ...
            if (s != null) {
                ...
                if (UNITS_TO_METERS.containsKey(s)) {
                    ...
                    throw new ProjectionConfigurationException(MessageFormat.format("No unit found for: {0}", s));
                }
            }
            ...
            if (m.matches()) {
                ...
                if (param == null) {
                    if (!ignoreUnknownParameter)
                        throw new ProjectionConfigurationException(MessageFormat.format("Unknown parameter: ''{0}''.", key));
                } else {
                    if (param.hasValue && value == null)
                        throw new ProjectionConfigurationException(MessageFormat.format("Value expected for parameter ''{0}''.", key));
                    if (!param.hasValue && value != null)
                        throw new ProjectionConfigurationException(MessageFormat.format("No value expected for parameter ''{0}''.", key));
                    key = param.key; // To be really sure, we might have an alias.
                }
                parameters.put(key, value);
            } else if (!part.startsWith("+")) {
                throw new ProjectionConfigurationException(MessageFormat.format("Parameter must begin with a ''+'' character (found ''{0}'')", part));
            } else {
                throw new ProjectionConfigurationException(MessageFormat.format("Unexpected parameter format (''{0}'')", part));
            }
        }
        return parameters;
    }
        ...
        if (initKey != null) {
            ...
            try {
                initp = parseParameterList(Optional.ofNullable(Projections.getInit(initKey)).orElseThrow(
                        () -> new ProjectionConfigurationException(MessageFormat.format("Value ''{0}'' for option +init not supported.", initKey))),
    ...
    public Ellipsoid parseEllipsoid(Map<String, String> parameters) throws ProjectionConfigurationException {
        ...
        if (code != null) {
            return Optional.ofNullable(Projections.getEllipsoid(code)).orElseThrow(
                () -> new ProjectionConfigurationException(MessageFormat.format("Ellipsoid ''{0}'' not supported.", code)));
        }
    ...
    public Datum parseDatum(Map<String, String> parameters, Ellipsoid ellps) throws ProjectionConfigurationException {
        ...
        if (datumId != null) {
            result = Optional.ofNullable(Projections.getDatum(datumId)).orElseThrow(
                    () -> new ProjectionConfigurationException(MessageFormat.format("Unknown datum identifier: ''{0}''", datumId)));
        }
        if (ellps == null) {
        ...
        if (nadgridsId != null) {
            ...
            return new NTV2Datum(fNadgridsId, null, ellps, Optional.ofNullable(Projections.getNTV2Grid(fNadgridsId)).orElseThrow(
                    () -> new ProjectionConfigurationException(MessageFormat.format("Grid shift file ''{0}'' for option +nadgrids not supported.", fNadgridsId))));
        }
    ...
    public Datum parseToWGS84(String paramList, Ellipsoid ellps) throws ProjectionConfigurationException {
        ...
        for (String str : numStr) {
            try {
                ...
                throw new ProjectionConfigurationException(MessageFormat.format("Unable to parse value of parameter ''towgs84'' (''{0}'')", str), e);
            }
        }
    ...
    public Proj parseProjection(Map<String, String> parameters, Ellipsoid ellps) throws ProjectionConfigurationException {
        ...
        if (proj == null) throw new ProjectionConfigurationException(MessageFormat.format("Unknown projection identifier: ''{0}''", id));
    ...
    public static double parseDouble(Map<String, String> parameters, String parameterName) throws ProjectionConfigurationException {
        if (!parameters.containsKey(parameterName))
            throw new ProjectionConfigurationException(MessageFormat.format("Unknown parameter: ''{0}''.", parameterName));
        return parseDouble(Optional.ofNullable(parameters.get(parameterName)).orElseThrow(
                () -> new ProjectionConfigurationException(MessageFormat.format("Expected number argument for parameter ''{0}''", parameterName))),
                parameterName);
    }
    ...
    public static double parseDouble(String doubleStr, String parameterName) throws ProjectionConfigurationException {
        try {
            ...
            throw new ProjectionConfigurationException(
                    MessageFormat.format("Unable to parse value ''{1}'' of parameter ''{0}'' as number.", parameterName, doubleStr), e);
        }
    }
    ...
    public static double parseAngle(String angleStr, String parameterName) throws ProjectionConfigurationException {
        try {
            ...
            throw new ProjectionConfigurationException(
                    MessageFormat.format("Unable to parse value ''{1}'' of parameter ''{0}'' as coordinate value.", parameterName, angleStr), e);
        }
    }
