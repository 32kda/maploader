...
public class EmailValidator extends AbstractValidator {
    ...
    public boolean isValid(String email) {
        ...
        if (email.endsWith(".")) { // check this first - it's cheap!
            setErrorMessage(MessageFormat.format("E-mail address is invalid"));
            return false;
        }
        ...
        if (!isValidUser(username)) {
            setErrorMessage(MessageFormat.format("E-mail address contains an invalid username: {0}", username));
            return false;
        }

        String domain = emailMatcher.group(2);
        if (!isValidDomain(domain)) {
            setErrorMessage(MessageFormat.format("E-mail address contains an invalid domain: {0}", domain));
            return false;
        }
    ...
    public String getValidatorName() {
        return MessageFormat.format("Email validator");
    }
