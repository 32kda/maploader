...
public final class HttpClient {
    ...
    public Response connect(ProgressMonitor progressMonitor) throws IOException {
        if (progressMonitor == null) {
            progressMonitor = org.openstreetmap.josm.gui.progress.NullProgressMonitor.INSTANCE;
        }
        ...
        progressMonitor.beginTask("Contacting Server...", 1);
...
//                }
            ...
            if (isRedirect(connection.getResponseCode())) {
                ...
                if (redirectLocation == null) {
                    ...
                    throw new IOException(MessageFormat.format("Unexpected response from HTTP server. Got {0} response without ''Location'' header." +
