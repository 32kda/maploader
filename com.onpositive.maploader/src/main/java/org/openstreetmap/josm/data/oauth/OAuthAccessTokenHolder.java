...
public class OAuthAccessTokenHolder {
    ...
    public void init(CredentialsAgent cm) {
        ...
        try {
            ...
            Logging.error(e);
            Logging.warn(MessageFormat.format("Failed to retrieve OAuth Access Token from credential manager"));
            Logging.warn(MessageFormat.format("Current credential manager is of type ''{0}''", cm.getClass().getName()));
        }
    ...
    public void save(CredentialsAgent cm) {
        ...
        try {
            ...
            Logging.error(e);
            Logging.warn(MessageFormat.format("Failed to store OAuth Access Token to credentials manager"));
            Logging.warn(MessageFormat.format("Current credential manager is of type ''{0}''", cm.getClass().getName()));
        }
    }
