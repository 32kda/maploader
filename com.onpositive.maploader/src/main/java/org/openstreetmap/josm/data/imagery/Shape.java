    ...
    public void addPoint(String sLat, String sLon) {
        ...
        try {
            ...
            if (!LatLon.isValidLat(lat))
                throw new IllegalArgumentException(MessageFormat.format("Illegal latitude value ''{0}''", lat));
        ...
        try {
            ...
            if (!LatLon.isValidLon(lon))
                throw new IllegalArgumentException(MessageFormat.format("Illegal longitude value ''{0}''", lon));
        } catch (NumberFormatException e) {
